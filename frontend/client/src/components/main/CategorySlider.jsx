    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute top-[-50px] right-[50px] transform -translate-y-1/2 bg-white text-black hover:bg-black hover:text-white px-3 py-2 border rounded-lg shadow-md z-10 hidden md:block"
          >
            ←
          </button>
          ...
          <button
            onClick={nextSlide}
            className="absolute top-[-50px] right-0 transform -translate-y-1/2 bg-white text-black hover:bg-black hover:text-white px-3 py-2 border rounded-lg shadow-md z-10 hidden md:block"
          >
            →
          </button>
        </div>
