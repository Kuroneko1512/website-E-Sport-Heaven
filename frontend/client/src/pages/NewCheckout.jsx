...
const useAddressData = () => {
  ...
  return { provinces, districts, wards, loadDistricts, loadWards, provincesLoading, districtsLoading, wardsLoading };
};
          ...
          >
            <Select
              ...
              onChange={(val) => {
                ...
                loadWards(val); // Đảm bảo các xã được tải khi một huyện được chọn
              }}
